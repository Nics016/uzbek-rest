...
class Auth_Frontend_Html {
    ...
    function render(&$caller, $username = '') {
        ...
        print '<tr>'."\n";
        print '    <td colspan="2" bgcolor="#eeeeee"><strong>Вход </strong>'
            .$status.'</td>'."\n";
        print '</tr>'."\n";
        print '<tr>'."\n";
        print '    <td>Пользователь:</td>'."\n";
        ...
        print '    <td colspan="2" bgcolor="#eeeeee"><input value="Вход" '
